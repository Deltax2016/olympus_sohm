...
export class sOHM2__rebasesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
  value3: BigInt;
...
export class sOHM2 extends ethereum.SmartContract {
  static bind(address: Address): sOHM2 {
    return new sOHM2("sOHM2", address);
  }
  ...
  rebases(param0: BigInt): sOHM2__rebasesResult {
    let result = super.call(
      "rebases",
    ...
    return new sOHM2__rebasesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt(),
      result[3].toBigInt(),
  ...
  try_rebases(param0: BigInt): ethereum.CallResult<sOHM2__rebasesResult> {
    let result = super.tryCall(
      "rebases",
      "rebases(uint256):(uint256,uint256,uint256,uint256,uint256,uint256,uint256)",
      [ethereum.Value.fromUnsignedBigInt(param0)]
